<template>
	<view class="register">
		...
		<view class="content padding-top-lg">
			...
			<!-- 底部信息 -->
			<view class="footer">
				<text @tap="isShowAgree" class="cuIcon" :class="showAgree?'cuIcon-radiobox':'cuIcon-round'">我已阅读并同意</text>
				<!-- 协议地址 -->
				<navigator url="" class="text text-blue" open-type="navigate">《会员协议》</navigator>
			</view>
		</view>
	</view>
</template>
